---
{"dg-publish":true,"permalink":"/3-mechanics/cli/books/dungeon-masters-guide-2024/03-chapter-3-dms-toolbox/","tags":["ttrpg-cli/compendium/src/5e/xdmg"],"created":"2025-02-22T12:02:28.532-05:00","updated":"2025-02-26T17:46:10.040-05:00"}
---
...
- **Disciple of the Nine Hells.** When the creature dies, its body disgorges a [Hostile [Attitude]](3-Mechanics/CLI/rules/variant-rules/hostile-attitude-xphb.md) [Imp](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) in the same space.  
...
- **Slaad Host.** When the creature dies, a [Hostile [Attitude]](3-Mechanics/CLI/rules/variant-rules/hostile-attitude-xphb.md) [Slaad Tadpole](3-Mechanics/CLI/bestiary/aberration/slaad-tadpole-xmm.md) bursts from its innards in the same space.  
...
> 
> Developing nonplayer characters can be fun. That said, use your time wisely. Don't write three pages of backstory for an NPC whose interactions with the adventurers will be over in three minutes. The advice in this section is meant to help you create an interesting character quickly while providing just enough detail.{ #dont-go-overboard}
...
> 
> For an example of a settlement map, see the Crossroads Village map in "appendix B".{ #do-i-need-a-settlement-map}
