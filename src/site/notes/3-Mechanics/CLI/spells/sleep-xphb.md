...
Each creature of your choice in a 5-foot-radius Sphere centered on a point within range must succeed on a Wisdom saving throw or have the [[3-Mechanics/CLI/rules/conditions#Incapacitated\|Incapacitated]] condition until the end of its next turn, at which point it must repeat the save. If the target fails the second save, the target has the [[3-Mechanics/CLI/rules/conditions#Unconscious\|Unconscious]] condition for the duration. The spell ends on a target if it takes damage or someone within 5 feet of it takes an action to shake it out of the spell's effect.

Creatures that don't sleep, such as elves, or that have [[3-Mechanics/CLI/rules/variant-rules/immunity-xphb\|Immunity]] to the [[3-Mechanics/CLI/rules/conditions#Exhaustion\|Exhaustion]] condition automatically succeed on saves against this spell.
