...
You place a curse on a creature that you can see within range. Until the spell ends, you deal an extra `1d6` Necrotic damage to the target whenever you hit it with an attack roll. Also, choose one ability when you cast the spell. The target has [[3-Mechanics/CLI/rules/variant-rules/disadvantage-xphb\|Disadvantage]] on ability checks made with the chosen ability.

If the target drops to 0 [[3-Mechanics/CLI/rules/variant-rules/hit-points-xphb\|Hit Points]] before this spell ends, you can take a [[3-Mechanics/CLI/rules/variant-rules/bonus-action-xphb\|Bonus Action]] on a later turn to curse a new creature.

**Using a Higher-Level Spell Slot.** Your [[3-Mechanics/CLI/rules/conditions#Concentration\|Concentration]] can last longer with a spell slot of level 2 (up to 4 hours), 3-4 (up to 8 hours), or 5+ (24 hours).
