...
You attempt to interrupt a creature in the process of casting a spell. The creature makes a Constitution saving throw. On a failed save, the spell dissipates with no effect, and the action, [[3-Mechanics/CLI/rules/variant-rules/bonus-action-xphb\|Bonus Action]], or [[3-Mechanics/CLI/rules/variant-rules/reaction-xphb\|Reaction]] used to cast it is wasted. If that spell was cast with a spell slot, the slot isn't expended.
