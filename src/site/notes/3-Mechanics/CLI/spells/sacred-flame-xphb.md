...
Flame-like radiance descends on a creature that you can see within range. The target must succeed on a Dexterity saving throw or take `1d8` Radiant damage. The target gains no benefit from Half [[3-Mechanics/CLI/rules/variant-rules/cover-xphb\|Cover]] or Three-Quarters [[3-Mechanics/CLI/rules/variant-rules/cover-xphb\|Cover]] for this save.
