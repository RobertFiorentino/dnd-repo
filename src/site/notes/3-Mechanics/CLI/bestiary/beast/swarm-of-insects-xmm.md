...
- "desc": "Melee Attack: +3, reach 5 ft. Hit: 6 (2d4 + 1) Poison damage, or\
    \ 3 (1d4 + 1) Poison damage if the swarm is [Bloodied](3-Mechanics/CLI/rules/variant-rules/bloodied-xphb.md)."
  "name": "Bites"
"source":
- "XMM"
```{ #statblock}
