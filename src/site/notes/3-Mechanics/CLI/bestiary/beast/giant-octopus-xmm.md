...
- "desc": "Trigger: The octopus takes damage while underwater. Response: The octopus\
    \ releases ink that fills a 10-foot [Cube [Area of Effect]](3-Mechanics/CLI/rules/variant-rules/cube-area-of-effect-xphb.md)\
