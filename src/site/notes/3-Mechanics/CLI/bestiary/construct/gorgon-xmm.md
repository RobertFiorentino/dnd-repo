...
- "desc": "Melee Attack: +8, reach 5 ft. Hit: 18 (2d12 + 5) Piercing damage.\
    ...
    \ toward it immediately before the hit, the target has the [Prone](3-Mechanics/CLI/rules/conditions.md#Prone)\
    \ condition."
  "name": "Gore"
- "desc": "Constitution Saving Throw: DC 15, each creature in a 30-foot [Cone [Area\
    ...
    \ {@actSaveFail 1} The target has the [Restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
