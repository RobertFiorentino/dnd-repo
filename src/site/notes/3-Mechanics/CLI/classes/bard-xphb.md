---
{"dg-publish":true,"permalink":"/3-mechanics/cli/classes/bard-xphb/","tags":["ttrpg-cli/class/bard","ttrpg-cli/compendium/src/5e/xphb"],"created":"2025-04-10T15:32:05.000-04:00","updated":"2025-04-10T15:32:05.000-04:00","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/class/bard","ttrpg-cli/compendium/src/5e/xphb"],"aliases":["Bard"]}}
---
...
- **Skill Proficiencies**: Choose 3 [[3-Mechanics/CLI/rules/skills\|skills]]
- **Weapon Proficiencies**: Simple weapons
- **Tool Proficiencies**: Choose three [[3-Mechanics/CLI/items/musical-instrument-xphb\|Musical Instruments]]
- **Armor Training**: [[3-Mechanics/CLI/rules/item-types#Light Armor\|Light armor]]

**Starting Equipment:** *Choose A or B:* (A) [[3-Mechanics/CLI/items/leather-armor-xphb\|Leather Armor]], 2 [[3-Mechanics/CLI/items/dagger-xphb\|Dagger]], [[3-Mechanics/CLI/items/musical-instrument-xphb\|Musical Instrument]] of your choice, [[3-Mechanics/CLI/items/entertainers-pack-xphb\|Entertainer's Pack]], 19 GP; or (B) 90 GP

## Multiclassing Bard

- **Skill Proficiencies**: Choose 1 [[3-Mechanics/CLI/rules/skills\|skill]]
- **Tool Proficiencies**: Choose one [[3-Mechanics/CLI/items/musical-instrument-xphb\|Musical Instrument]]
- **Armor Training**: [[3-Mechanics/CLI/rules/item-types#Light Armor\|Light armor]]
...
As a [[3-Mechanics/CLI/rules/variant-rules/bonus-action-xphb\|Bonus Action]], you can inspire another creature within 60 feet of yourself who can see or hear you. That creature gains one of your Bardic Inspiration dice. A creature can have only one Bardic Inspiration die at a time.

Once within the next hour when the creature fails a [[3-Mechanics/CLI/rules/variant-rules/d20-test-xphb\|D20 Test]], the creature can roll the Bardic Inspiration die and add the number rolled to the `d20`, potentially turning the failure into a success. A Bardic Inspiration die is expended when it's rolled.

#### Number of Uses

You can confer a Bardic Inspiration die a number of times equal to your Charisma modifier (minimum of once), and you regain all expended uses when you finish a [[3-Mechanics/CLI/rules/variant-rules/long-rest-xphb\|Long Rest]].
...
You know two cantrips of your choice from the Bard spell list. [[3-Mechanics/CLI/spells/dancing-lights-xphb\|Dancing Lights]] and [[3-Mechanics/CLI/spells/vicious-mockery-xphb\|Vicious Mockery]] are recommended.
...
The Bard Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [[3-Mechanics/CLI/rules/variant-rules/long-rest-xphb\|Long Rest]].

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Bard spell list. [[3-Mechanics/CLI/spells/charm-person-xphb\|Charm Person]], [[3-Mechanics/CLI/spells/color-spray-xphb\|Color Spray]], [[3-Mechanics/CLI/spells/dissonant-whispers-xphb\|Dissonant Whispers]], and [[3-Mechanics/CLI/spells/healing-word-xphb\|Healing Word]] are recommended.
...
You can use a [[3-Mechanics/CLI/items/musical-instrument-xphb\|Musical Instrument]] as a [[3-Mechanics/CLI/rules/variant-rules/spellcasting-focus-xphb\|Spellcasting Focus]] for your Bard spells.

### Expertise (Level 2)

You gain [[3-Mechanics/CLI/rules/variant-rules/expertise-xphb\|Expertise]] in two of your skill proficiencies of your choice. [[3-Mechanics/CLI/rules/skills#Performance\|Performance]] and [[3-Mechanics/CLI/rules/skills#Persuasion\|Persuasion]] are recommended if you have proficiency in them.

At Bard level 9, you gain [[3-Mechanics/CLI/rules/variant-rules/expertise-xphb\|Expertise]] in two more of your skill proficiencies of your choice.

### Jack of All Trades (Level 2)

You can add half your [[3-Mechanics/CLI/rules/variant-rules/proficiency-xphb\|Proficiency]] (round down) to any ability check you make that uses a skill proficiency you lack and that doesn't otherwise use your [[3-Mechanics/CLI/rules/variant-rules/proficiency-xphb\|Proficiency]].

For example, if you make a Strength ([[3-Mechanics/CLI/rules/skills#Athletics\|Athletics]]) check and lack [[3-Mechanics/CLI/rules/skills#Athletics\|Athletics]] proficiency, you can add half your [[3-Mechanics/CLI/rules/variant-rules/proficiency-xphb\|Proficiency]] to the check.

> [!note] A Bard's Repertoire
> 
> Does your Bard beat a [[3-Mechanics/CLI/items/drum-xphb\|drum]] while chanting the deeds of ancient heroes? Strum a [[3-Mechanics/CLI/items/lute-xphb\|lute]] while crooning romantic tunes? Perform arias of stirring power? Recite dramatic monologues from classic tragedies? Use the rhythm of a folk dance to coordinate the movement of allies in battle? Compose naughty limericks?
> 
...
You gain the [[3-Mechanics/CLI/feats/ability-score-improvement-xphb\|Ability Score Improvement]] feat or another feat of your choice for which you qualify. You gain this feature again at Bard levels 8, 12, and 16.

### Font of Inspiration (Level 5)

You now regain all your expended uses of Bardic Inspiration when you finish a [[3-Mechanics/CLI/rules/variant-rules/short-rest-xphb\|Short Rest]] or [[3-Mechanics/CLI/rules/variant-rules/long-rest-xphb\|Long Rest]].
...
You can use musical notes or words of power to disrupt mind-influencing effects. If you or a creature within 30 feet of you fails a saving throw against an effect that applies the [[3-Mechanics/CLI/rules/conditions#Charmed\|Charmed]] or [[3-Mechanics/CLI/rules/conditions#Frightened\|Frightened]] condition, you can take a [[3-Mechanics/CLI/rules/variant-rules/reaction-xphb\|Reaction]] to cause the save to be rerolled, and the new roll has [[3-Mechanics/CLI/rules/variant-rules/advantage-xphb\|Advantage]].
...
When you roll [[3-Mechanics/CLI/rules/variant-rules/initiative-xphb\|Initiative]], you regain expended uses of Bardic Inspiration until you have two if you have fewer than that.

### Epic Boon (Level 19)

You gain an Epic Boon feat or another feat of your choice for which you qualify. [[3-Mechanics/CLI/feats/boon-of-spell-recall-xphb\|Boon of Spell Recall]] is recommended.

### Words of Creation (Level 20)

You have mastered two of the Words of Creation: the words of life and death. You therefore always have the [[3-Mechanics/CLI/spells/power-word-heal-xphb\|Power Word Heal]] and [[3-Mechanics/CLI/spells/power-word-kill-xphb\|Power Word Kill]] spells prepared. When you cast either spell, you can target a second creature with it if that creature is within 10 feet of the first target.