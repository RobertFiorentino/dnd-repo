---
{"dg-publish":true,"permalink":"/z-templates/template-player/","tags":["player"],"created":"2025-02-19T20:56:05.000-05:00","updated":"2025-02-24T20:34:39.407-05:00"}
---
...
| -------------------------------------------------- | ----------------- | -------------- | ------------- | ------------ | ------------- |
| ![[ImagePlaceholder.png\|cover hsmall]] | TemplatePlayer |  `VIEW[{Player}]` | `VIEW[{Class}]` | `VIEW[{Race}]` | `VIEW[{level}]` |
