---
{"dg-publish":true,"permalink":"/1-party/the-plague-wardens/jelma/","tags":["player"],"created":"2025-02-22T17:41:23.822-05:00","updated":"2025-02-24T20:31:12.276-05:00"}
---
...
| -------------------------------------------------- | ----------------- | -------------- | ------------- | ------------ | ------------- |
| ![[ImagePlaceholder.png\|cover hsmall]] | Jelma |  `VIEW[{Player}]` | `VIEW[{Class}]` | `VIEW[{Race}]` | `VIEW[{level}]` |
