---
{"dg-publish":true,"permalink":"/1-party/the-plague-wardens/cynthoria/","tags":["player"],"created":"2025-02-22T17:45:25.305-05:00","updated":"2025-02-24T21:06:50.045-05:00"}
---
...
| -------------------------------------------------- | ----------------- | -------------- | ------------- | ------------ | ------------- |
| ![[ImagePlaceholder.png\|cover hsmall]] | Cynthoria |  `VIEW[{Player}]` | `VIEW[{Class}]` | `VIEW[{Race}]` | `VIEW[{level}]` |
