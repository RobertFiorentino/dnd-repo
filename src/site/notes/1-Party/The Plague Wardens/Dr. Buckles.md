---
{"dg-publish":true,"permalink":"/1-party/the-plague-wardens/dr-buckles/","tags":["player"],"created":"2025-02-22T17:44:04.862-05:00","updated":"2025-02-25T12:43:30.880-05:00"}
---
...
| -------------------------- | ----------------- | ---------------- | --------------- | -------------- | --------------- |
| ![DrBucklesPortrait.png](/img/user/z_Assets/DrBucklesPortrait.png) | Dr. Buckles | `VIEW[{Player}]` | `VIEW[{Class}]` | `VIEW[{Race}]` | `VIEW[{level}]` |
