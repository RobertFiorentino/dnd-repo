---
{"dg-publish":true,"permalink":"/1-party/the-plague-wardens/dr-buckles/","tags":["player"],"created":"2025-02-22T17:44:04.862-05:00","updated":"2025-02-24T20:30:41.736-05:00"}
---
...
| ------------------------------- | ----------------- | ---------------- | --------------- | -------------- | --------------- |
| ![[DrBucklesPortrait.png\|300]] | Dr. Buckles | `VIEW[{Player}]` | `VIEW[{Class}]` | `VIEW[{Race}]` | `VIEW[{level}]` |
