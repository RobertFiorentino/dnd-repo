---
{"dg-publish":true,"permalink":"/1-party/the-plague-wardens/cinder/","tags":["player"],"created":"2025-02-22T14:10:57.263-05:00","updated":"2025-02-24T20:30:51.606-05:00"}
---
...
| ---------------- | ----------------- | ---------------- | --------------- | -------------- | --------------- |
| ![Cinder4.png](/img/user/z_Assets/Cinder4.png) | Cinder | `VIEW[{Player}]` | `VIEW[{Class}]` | `VIEW[{Race}]` | `VIEW[{level}]` |
|                  |                   |                  |                 |                |                 |
