---
{"dg-publish":true,"permalink":"/1-party/the-plague-wardens/ragnar/","tags":["player"],"created":"2025-02-22T17:29:55.744-05:00","updated":"2025-02-24T20:31:20.398-05:00"}
---
...
| -------------------------------------------------- | ----------------- | -------------- | ------------- | ------------ | ------------- |
| ![[ImagePlaceholder.png\|cover hsmall]] | Ragnar |  `VIEW[{Player}]` | `VIEW[{Class}]` | `VIEW[{Race}]` | `VIEW[{level}]` |
